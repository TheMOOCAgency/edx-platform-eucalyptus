...
(function() {
  ...
  describe('Problem', function() {
    ...
    describe('renderProgressState', function() {
      ...
      testProgessData = function(problem, status, detail, graded, expected_progress_after_render) {
      ...
      describe('with a status of "none"', function() {
        it('reports the number of points possible and graded', function() {
          return testProgessData(this.problem, 'none', '0/1', "True", "1 point possible (graded)");
        });
        it('displays the number of points possible when rendering happens with the content', function() {
          return testProgessData(this.problem, 'none', '0/2', "True", "2 points possible (graded)");
        });
        it('reports the number of points possible and ungraded', function() {
          return testProgessData(this.problem, 'none', '0/1', "False", "1 point possible (ungraded)");
        });
        it('displays ungraded if number of points possible is 0', function() {
          return testProgessData(this.problem, 'none', '0', "False", "0 points possible (ungraded)");
        });
        return it('displays ungraded if number of points possible is 0, even if graded value is True', function() {
          return testProgessData(this.problem, 'none', '0', "True", "0 points possible (ungraded)");
        });
      });
      describe('with any other valid status', function() {
        it('reports the current score', function() {
          return testProgessData(this.problem, 'foo', '1/1', "True", "1/1 point (graded)");
        });
        it('shows current score when rendering happens with the content', function() {
          return testProgessData(this.problem, 'test status', '2/2', "True", "2/2 points (graded)");
        });
        return it('reports the current score even if problem is ungraded', function() {
          return testProgessData(this.problem, 'test status', '1/1', "False", "1/1 point (ungraded)");
        });
      });
      return describe('with valid status and string containing an integer like "0" for detail', function() {
        return it('shows 0 points possible for the detail', function() {
          return testProgessData(this.problem, 'foo', '0', "False", "");
        });
      });
    });
    ...
    describe('submit', function() {
      ...
      describe('when the response is correct', function() {
        return it('call render with returned content', function() {
          var contents;
          contents = '<section aria-label="Question 1"><p>Correct<span class="status">excellent</span></p></section>' + '<section aria-label="Question 2"><p>Yep<span class="status">correct</span></p></section>';
          spyOn($, 'postWithPrefix').and.callFake(function(url, answers, callback) {
            var promise;
            callback({
              success: 'correct',
