...
# Enrollment workflow
TMA_ENROLLMENT_REQUEST_EMAIL = ENV_TOKENS.get('TMA_ENROLLMENT_REQUEST_EMAIL', TMA_ENROLLMENT_REQUEST_EMAIL)

# PROFILE IMAGE CONFIG
IDENTITY_PROOF_BACKEND = ENV_TOKENS.get('IDENTITY_PROOF_BACKEND', IDENTITY_PROOF_BACKEND)
IDENTITY_PROOF_MAX_BYTES = ENV_TOKENS.get('IDENTITY_PROOF_MAX_BYTES', IDENTITY_PROOF_MAX_BYTES)
IDENTITY_PROOF_MIN_BYTES = ENV_TOKENS.get('IDENTITY_PROOF_MIN_BYTES', IDENTITY_PROOF_MIN_BYTES)

# CSV grade reports
TMA_MERGED_REPORTS_PATH = ENV_TOKENS.get('TMA_MERGED_REPORTS_PATH', TMA_MERGED_REPORTS_PATH)
TMA_MERGED_REPORTS_NAME = ENV_TOKENS.get('TMA_MERGED_REPORTS_NAME', TMA_MERGED_REPORTS_NAME)
